...
<head>
	...
	<title>DriveZy Driver Login</title>
        ...
        <div class="container">
            <div class="login-content" style="opacity: 0.8;">
                ...
                <div class="login-form">
                	<h2>Login</h2>
                    <form id="userLoginForm" action="driverLoginAaction.jsp" method="POST">
                        ...
                        <div class="register-link m-t-15 text-center">
                            <p>Don't have account? <a href="../register/driverRegister.jsp"> Sign Up Here</a></p>
                        </div>
                    </form>
                </div>
            </div>
